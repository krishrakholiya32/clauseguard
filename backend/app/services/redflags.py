...
REDFLAG_CHECKLISTS: dict[str, list[str]] = {
    ...
    "partnership": [
        "Profit/loss sharing ratios not clearly defined or subject to unilateral change by one partner",
        "No clear exit mechanism or buyout procedure for a partner wishing to leave",
        "Decision-making authority concentrated in one partner with no checks or veto rights",
        "No agreed valuation methodology for buying out a departing or deceased partner",
        "Unlimited personal liability without any protection for capital contributions",
        "Capital contribution obligations with no corresponding equity or benefit defined",
        "Non-compete clauses preventing partners from pursuing related opportunities post-exit",
        "No dispute resolution or deadlock-breaking mechanism between partners",
    ],
    "vendor": [
        "Payment terms excessively delayed (e.g. 90+ days) with no interest on late payment",
        "Unilateral right for the buyer to cancel orders without adequate cancellation compensation",
        "Excessive warranty or indemnity obligations placed solely on the vendor",
        "Price revision clauses allowing the buyer to demand discounts without prior notice",
        "Exclusivity requirements preventing the vendor from serving other clients",
        "No clear dispute or rejection process for delayed, defective, or refused deliveries",
        "Broad IP rights assignment over vendor's processes, designs, or trade secrets",
        "Unlimited liability clauses disproportionate to the contract value",
    ],
    "consulting": [
        "Scope of work is vague, allowing unlimited scope creep without additional payment",
        "Payment contingent on vague 'acceptance' or 'satisfaction' criteria defined solely by the client",
        "Overly broad IP transfer clauses assigning all work product, including pre-existing tools, to the client",
        "Non-compete clauses that are excessively broad in scope, duration, or geography for a short engagement",
        "No clear deliverable timelines, milestones, or acceptance criteria",
        "Indemnification clauses placing unreasonable or unlimited liability on the consultant",
        "Termination without notice or compensation for work in progress",
        "Confidentiality obligations so broad they prevent the consultant from referencing the engagement in their portfolio",
    ],
    "software": [
        "Vendor right to terminate or deactivate the software license without adequate notice period",
        "Data ownership and export rights not clearly defined — vendor may retain or restrict access to user data",
        "Auto-renewal clauses with a short or unclear cancellation window before the renewal date",
        "Broad limitation of liability benefiting only the vendor, with no SLA remedy for downtime",
        "Unilateral right for the vendor to change software features, pricing, or terms during the license term",
        "Vague or unenforceable SLA commitments (uptime, support response) with no financial penalties for breach",
        "Audit clauses allowing the vendor to inspect customer systems in an intrusive or unscheduled manner",
        "Broad indemnification from the customer for any third-party claims arising from normal software use",
    ],
    "other": [
